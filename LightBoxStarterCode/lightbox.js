// change visibility of divID

function changeVisibility(divID){
	var element = document.getElementById(divID);

	//if element exists, toggle class name between hidden and unhidden
	if(element){
...
function displayLightBox(imageFile, alt){
	...
	//force big image to preload so we can have access to its width so it centers
