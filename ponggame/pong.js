...
function startBall(){
	...
	topSpeedOfBall = Math.random() * 2 + minSpeedOfBall; //3-4.999
	leftSpeedOfBall = direction * (Math.random() * 2 + minSpeedOfBall);
...
function show(){
	...
	document.getElementById('player1').innerHTML = score1.toString();
	document.getElementById('player2').innerHTML = score2.toString();
